...
$pdf->Cell(0, 10, utf8_decode($texto_presentacion), 0, 1);
$pdf->Ln(10);
...
foreach ($productos as $producto) {
    $pdf->Cell(80, 10, utf8_decode($producto['descripcion']), 1);
    $pdf->Cell(30, 10, $producto['cantidad'], 1, 0, 'C');
    $pdf->Cell(40, 10, '$' . $producto['precio'], 1, 0, 'C');
    $pdf->Cell(40, 10, '$' . number_format($producto['cantidad'] * $producto['precio'], 2), 1, 1, 'C');
}
$pdf->Ln(10); // Salto de línea
...
foreach ($condiciones_array as $condicion) {
    $pdf->Cell(0, 10, utf8_decode("- $condicion"), 0, 1);
}
$pdf->Ln(10);
